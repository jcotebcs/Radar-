...
- Lookup business licenses through RapidAPI when `BUSINESS_LICENSE_API_KEY` is set.
...
To enable the license lookup endpoint, supply a RapidAPI key:

```
export BUSINESS_LICENSE_API_KEY="your-rapidapi-key"
node server/server.js
```
